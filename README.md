...
- `run_pdf_tool.ps1` — PowerShell helper that creates/activates a virtual environment, installs `requirements.txt`, and runs `pdf_platform.py` (suitable for Windows PowerShell).
